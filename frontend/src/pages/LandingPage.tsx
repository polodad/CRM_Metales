                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8 py-24 sm:py-32">
                        <div className="mx-auto max-w-2xl text-center">
                            ...
                            <div className="flex items-center justify-center gap-x-6">
                                <Button onClick={() => navigate('/login')} className="px-8 py-3 text-lg" variant="primary">
                                    Comenzar Gratis
                                </Button>
                                <a href="#features" className="text-sm font-semibold leading-6 text-white hover:text-orange-400 transition">
